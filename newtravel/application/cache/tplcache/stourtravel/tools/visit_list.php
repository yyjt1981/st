  ...
  <div class="crumbs" id="dest_crumbs">
        ...
        <div class="filter" style="margin-top: 40px;">
            <span class="tit ml-10">筛选</span>
              <div id="time_choose">
                  <input type="text" name="starttime" value="开始时间" id="starttime" datadef="开始时间" style="height: 20px;line-height: 20px;color:#aaa" class="choosetime searchkey sty-txt1 set-text-xh wid_200 ml10 mt-4 h20 lh20" >
                  <input type="text" name="endtime" value="结束时间" id="endtime" datadef="结束时间" style="height: 20px;line-height: 20px;color:#aaa" class="choosetime searchkey sty-txt1 set-text-xh wid_200 ml10 mt-4 h20 lh20" >
              </div>
              <div id="agent_choose">
...
<script>
   ...
   var engine_list =<?php echo $engine_list;?>;
  Ext.onReady(
    function() 
    {
