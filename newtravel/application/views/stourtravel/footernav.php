...
<td valign="top" class="content-rt-td">
    ...
    <div class="content-nr">
    	<!--面包屑-->
    	<div class="crumbs">
            <label>位置：</label>首页 &gt; 设置中心 &gt; 基础设置 &gt; <span><span id="webname">主站</span>--底部导航</span>
      </div>
      <div class="content-nr">
        <!-- {template 'stourtravel/public/weblist'}-->
        <div class="w-set-con">
        	<div class="w-set-tit bom-arrow"><span class="on"><s></s>底部导航</span></div>
          <div class="w-set-nr">
            ...
            <div class="opn-btn">
            	<a class="save btn_save ml-10" href="javascript:;" onclick="saveFooterNav()">保存</a>
            </div>
...
<script>
    ...
    function addNav()
    {
        ...
        ST.Util.showBox('添加底部导航',ajaxurl,730,450,function(){
            getFooterNav();});
    ...
    function edit(id)
    {
        ...
        ST.Util.showBox('底部导航修改',boxurl,730,450,function(){ getFooterNav()});
