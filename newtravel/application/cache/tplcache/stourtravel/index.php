...
<head>
<meta charset="utf-8">
<title><?php echo $configinfo['cfg_webname'];?>-思途CMS3.0</title>
...
<div class="header" id="header">
  <div class="top-page">
    ...
    <iframe id="indexfrm" src="<?php echo $cmsur;?>index/index_new" width="100%" height="100%" style="position: absolute;left:0;top:0;z-index:9999;border:0"></iframe>
