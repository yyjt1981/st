...
//        'xyorder'=>array('name'=>'协议订单','url'=>'order/xy/parentkey/order/itemid/15/','itemid'=>'15','ico'=>'chindren-ico-61.png'),
    ...
    //分类设置
    'kind'=>array(
        'destination'=>array('name'=>'夏令营种类','url'=>'destination/destination/parentkey/kind/itemid/1','itemid'=>'1','ico'=>'chindren-ico-04.png'),
        'startplace'=>array('name'=>'出发地','url'=>'startplace/index/parentkey/kind/itemid/2','itemid'=>'2','ico'=>'chindren-ico-25.png'),
        'line'=>array('name'=>'行程属性','url'=>'line/price/parentkey/kind/itemid/3','itemid'=>'3','ico'=>'chindren-ico-46.png'),
