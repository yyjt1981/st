...
function lib_attrgrouplist(&$ctag,&$refObj)
{
    ...
    $attlist="row|8,flag|,typeid|1,filterid|";
	...
	$sql="select id,attrname as groupname from {$tablename} where webid=0 and pid=0 and isopen=1 {$w} order by displayorder asc limit 0,$row" ;
