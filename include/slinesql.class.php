 ...
 *
 * @version        $Id: Slinesql.class.php 16:39 2011.05.09 netman$
...
class SlineSql
{
    ...
    function Open($pconnect=FALSE)
    {
        ...
        if(!$this->linkID)
        {
            $this->DisplayError("Sline错误警告：<font color='red'>连接数据库失败，可能数据库密码不对或数据库服务器出错！</font>");
            exit();
        }
    ...
    function DisplayError($msg)
    {
        ...
        $emsg = '';
        $emsg .= "<div><h3>Sline Error Warning!</h3>\r\n";
        $emsg .= "<div><a href='http://www.heirui.cn' target='_blank' style='color:red'>Technical Support: http://www.heirui.cn</a></div>";
