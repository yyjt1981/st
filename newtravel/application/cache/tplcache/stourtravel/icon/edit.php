   ...
   <form id="frm" name="frm">
    <div class="out-box-con">
        <dl class="list_dl">
            ...
            <dd>
                 <input type="text" class="set-text-xh mt-4" name="kind" id="kind" value="<?php echo $info['kind'];?>" >
            </dd>
        </dl>
        <dl class="list_dl">
            ...
            <dd>
                <div class="up-file-div lh30 mt5 fl">
                    ...
                    <div id="img" style="margin-top: 5px;"><img id="litimg" src="<?php echo $info['picurl'];?>"   /></div>
                    <?php } else { ?>
        ...
        <dl class="list_dl">
            ...
            <dd>
                ...
                <input type="hidden" name="litpic" id="litpic" value="<?php echo $info['picurl'];?>">
            </dd>
        </dl>
    </div>
   </form>
