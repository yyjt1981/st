   ...
   * */
    ...
    * */
    public function action_ajax_get()
    {
        ...
        $arr = ORM::factory('weblist')->get_all();
        ...
        foreach($arr as $row)
        {
            ...
            $tr ='
                  <tr>
                  <td height="40" align="center">'.$row['webid'].'</td>
                  <td class="pl-30"><input type="text"  name="webname[]" class="tb-text text_300 pl-5" value="'.$row['webname'].'" /></td>
                  <td align="left">'.$row['weburl'].'</td>
