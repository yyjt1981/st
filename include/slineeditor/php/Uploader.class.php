...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    private function upFile( $base64 )
    {
        ...
        if ( $this->stateInfo == $this->stateMap[ 0 ] ) {
            ...
            {
                $waterfile = "../../../stourtravel/inc/mark/inc_photowatermark_main_config.php";
                if(file_exists($waterfile))
                {
                    require($waterfile);//引入水印配置文件
                    ...
                    if($photo_markon=="1")
                    {
                        ...
                        $this->setWater($bigimg,$photo_markimg,$photo_marktext,$photo_fontcolor,$photo_waterpos,$photo_fontsize,$photo_marktype,$photo_diaphaneity);//大图加水印
                        //$this->SetWater($bigimg,$photo_markimg,$photo_marktext,$photo_fontcolor,$photo_waterpos,$photo_fontsize,$photo_marktype);//大图加水印
                        //$this->SetWater($thumbimg,$photo_markimg,$photo_marktext,$photo_fontcolor,$photo_waterpos,$photo_fontsize,$photo_marktype);//小图加水印jnh
