                    ...
                    <div class="content-jieshao-detail" style="<?php  if($info['isstyle']==1) echo 'display:none'   ?>">
                        <?php
                           foreach($info['linejieshao_arr'] as $k=>$v)
                           {
                               ...
                               $jieshao.='<dd>';
                               $jieshao.='<span class="fl"><input class="fl mt-8" type="checkbox" '.$car_check.' name="transport['.$v['day'].'][]" value="2"/></span>';
                               $jieshao.='<label class="fl ml-5 mr-20" style="cursor:pointer;">汽车</label>';
                               $jieshao.='<span class="fl"><input class="fl mt-8" type="checkbox" name="transport['.$v['day'].'][]" '.$train_check.' value="3"></span>';
                               $jieshao.='<label class="fl ml-5 mr-20" style="cursor:pointer;">火车</label>';
                               $jieshao.='<span class="fl"><input class="fl mt-8" type="checkbox"value="1" '.$plane_check.' name="transport['.$v['day'].'][]"></span>';
                               $jieshao.='<label class="fl ml-5 mr-20" style="cursor:pointer;">飞机</label>';
                               $jieshao.='<span class="fl"><input class="fl mt-8" type="checkbox" name="transport['.$v['day'].'][]" '.$ship_check.' value="4"></span>';
                               $jieshao.='<label class="fl ml-5 mr-20" style="cursor:pointer;">轮船</label>';
                               $jieshao.='</dd>';
                               $jieshao.='</dl>';
...
<script>
    ...
    $('#attach_btn').uploadify({
        ...
        'buttonImage' : SITEURL+'/public/images/uploadfile.png',  //指定背景图
        'formData':{},
