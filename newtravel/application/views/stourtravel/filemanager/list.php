...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div id="line_grid_panel" class="content-nrt" style="margin-top: 50px">
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        return '<a href="javascript:;" onclick="pageedit(\''+id+'\',\''+ext+'\')">编辑</a>';
                    }
                }
...
function pageedit(id,ext)
{
    ...
    var boxurl = SITEURL+'filemanager/pageedit/?file='+file+'&ext='+ext;
