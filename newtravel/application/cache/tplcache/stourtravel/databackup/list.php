    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            <div class="crumbs" id="attr_crumbs">
                <label>位置：</label>
                首页</a> &gt; 基本设置 &gt; <span>数据备份</span>
            </div>
            <div></div>
            <div class="w-set-tit bom-arrow" style="float:none;margin-top: 40px">
                <?php echo  Stourweb_View::template('stourtravel/databackup/kindtop');  ?>
            </div>
        ...
        window.attr_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
               ...
               
                {
                    ...
                    text: '<span class="grid_column_text">表</span><img  src="/newhoutai/public/images/help-ico.png" class="grid_column_help" alt="帮助" title="帮助">',
                    dataIndex: 'name',
                    sortable:false,
                    locked: false,
                    width: '24%',
