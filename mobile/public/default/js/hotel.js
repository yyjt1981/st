	...
	$.ajax(	
	  {  
		...
		success: function(data, textStatus){
			 ...
			 {
				 plist+='<div class="pdt_list"><a href="'+hotellist[i]['url']+'"><div class="pdt_img"><img src="'+hotellist[i]['lit160']+'" width="90" height="64"></div><div class="pdt_txt"><div class="pdt_box"><p class="p_tit">'+hotellist[i]['hotelname']+'</p><p class="p_pir"><strong>'+hotellist[i]['price']+'</strong><span>满意度100%</span></p></div></div></a></div>';
			 }
			 if(name=='page')
			 {
				 $("#hotel_list").append(plist);
			 }
			 else
			   $("#hotel_list").html(plist);
