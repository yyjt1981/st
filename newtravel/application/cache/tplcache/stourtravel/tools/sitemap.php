    ...
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div class="sitemapbox">
                ...
                <ul class="desc">
                    <li>生成状态:<span class="gentxt"><?php echo $xmlinfo['text'];?></span></li>
                    <li>生成日期:<span class="gentxt"><?php echo $xmlinfo['time'];?></span></li>
                    <li>生成数量:<span class="gentxt"><?php echo $xmlinfo['number'];?></span></li>
                </ul>
                <ul>
                    <li><a class="txtbtn" onclick="genXmlMap()">生成XML</a></li>
                    <li><a class="linkbtn" target="_blank" href="../Sitemap.xml">查看SiteMap</a></li>
            ...
            <div class="sitemapbox">
                ...
                <ul class="desc">
                    <li>生成状态:<span class="gentxt"><?php echo $htmlinfo['text'];?></span></li>
                    <li>生成日期:<span class="gentxt"><?php echo $htmlinfo['time'];?></span></li>
                    <li>生成数量:<span class="gentxt"><?php echo $htmlinfo['number'];?></span></li>
                </ul>
                <ul>
                    <li><a class="txtbtn" onclick="genHtmlMap()">生成HTML</a></li>
                    <li><a class="linkbtn" target="_blank" href="../Sitemap.html">查看地图</a></li>
            ...
            <div class="sitemapbox">
                ...
                <ul class="desc">
                    <li>生成状态:<span class="gentxt"><?php echo $errinfo['text'];?></span></li>
                    <li>生成日期:<span class="gentxt"><?php echo $errinfo['time'];?></span></li>
                    <li>生成数量:<span class="gentxt"><?php echo $errinfo['number'];?></span></li>
                </ul>
                <ul>
                    <li><a class="txtbtn" onclick="gen404Map()">生成死链</a></li>
                    <li><a class="linkbtn" target="_blank" href="../404Sitemap.txt">查看死链</a></li>
