...
Ext.onReady(
    ...
    function () {
        ...
        window.attr_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
                {
                    text: '<span class="grid_column_text">选择</span><img  src="/newhoutai/public/images/help-ico.png" onclick="getHelp(event)" class="grid_column_help" alt="帮助" title="帮助">',
                    width: '8%',
                    dataIndex: 'text',
                    tdCls: 'attr-al-mid',
                    align: 'center',
               ...
               
                {
                    ...
                    text: '<span class="grid_column_text">备份包</span><img  src="/newhoutai/public/images/help-ico.png" class="grid_column_help" alt="帮助" title="帮助">',
                    dataIndex: 'text',
                    sortable:false,
                    locked: false,
                    width: '24%',
                ...
                {
                    text: '<span class="grid_column_text">中文名</span><img  src="/newhoutai/public/images/help-ico.png" class="grid_column_help" alt="帮助" title="帮助">',
                    dataIndex: 'name',
                    sortable:false,
                    locked: false,
                    width: '24%',
                ...
                {
                    text: '<span class="grid_column_text">说明</span><img  src="/newhoutai/public/images/help-ico.png" class="grid_column_help" alt="帮助" title="帮助">',
                    dataIndex: 'beizu',
                    width: '35%',
                    sortable:false,
                    renderer : function(value, metadata,record) {
                ...
                {
                    text: '<span class="grid_column_text">删除</span><img  src="/newhoutai/public/images/help-ico.png" class="grid_column_help" alt="帮助" title="帮助">',
                    dataIndex: 'text',
                    width: '9%',
                    sortable:false,
                    renderer : function(value, metadata,record) {
