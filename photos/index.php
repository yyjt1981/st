...
if(!empty($dest_id))
{
	...
	$tableorder = " ifnull(b.isding,0) desc,ifnull(b.isjian,0) desc,ifnull(b.displayorder,9999) asc";
...
if(!empty($destname)||!empty($attrname))
{
    $seotitle.=$destname.$attrname;
	$pv->Fields['seotitle']=$seotitle;
	
}

$pv->SetTemplet(SLINETEMPLATE ."/".$cfg_df_style ."/" ."photos/" ."photo_index.htm");
$pv->Display();
